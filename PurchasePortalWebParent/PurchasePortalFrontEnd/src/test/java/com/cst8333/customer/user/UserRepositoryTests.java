...
//		Role roleAdmin = entityManager.find(Role.class,1);
	...
	public void testCreateNewUser() {
		...
		Customer customer = Customer.builder().companyName("Beta").phoneNumber("256-703-555555").address("Plot 524 Ntinda Rd")
				.city("Kampala").poBox("15698").build();
		User user = User.builder().email("Max@gmail.com").password("discover").firstName("Max").lastName("Payne").build();
